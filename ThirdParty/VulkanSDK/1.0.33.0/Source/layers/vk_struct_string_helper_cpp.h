...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #893
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #901
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #911
std::string vk_print_vkallocationcallbacks(const VkAllocationCallbacks* pStruct, const std::string prefix)
{
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #917
    ...
    stringstream ss[6];
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #1074
    if (StreamControl::writeAddress)
        ss[0] << "0x" << pStruct->pUserData;
    else
        ss[0].str("address");
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #1090
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #1117
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #917
    ...
    stringstream ss[3];
    string stp_strs[1];
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #1016
    if (pStruct->pNext) {
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #1074
    if (StreamControl::writeAddress)
        ...
        ss[0].str("address");
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #1080
    if (pStruct->pApplicationName != NULL) {
        ss[1] << pStruct->pApplicationName;
     } else {
        ss[1] << "";
     }
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #1097: NB Edit this section to choose hex vs dec output by variable name
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #943
        stp_strs[1] = "";
        ...
        if (pStruct->pWaitSemaphores) {
            for (uint32_t i = 0; i < pStruct->waitSemaphoreCount; i++) {
                index_ss.str("");
                index_ss << i;
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #994
                ss[1] << "0x" << pStruct->pWaitSemaphores[i];
                stp_strs[1] += " " + prefix + "pWaitSemaphores[" + index_ss.str() + "].handle = " + ss[1].str() + "\n";
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #1004
                ss[1].str("");
            }
        }
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #936
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #943
        ...
        if (pStruct->pBufferBinds) {
            for (uint32_t i = 0; i < pStruct->bufferBindCount; i++) {
                index_ss.str("");
                index_ss << i;
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #984
                ss[2] << "0x" << &pStruct->pBufferBinds[i];
                tmp_str = vk_print_vksparsebuffermemorybindinfo(&pStruct->pBufferBinds[i], extra_indent);
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #991
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #1094: NB: Edit here to choose hex vs dec output by variable name
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #917
    ...
    stringstream ss[6];
    string stp_strs[3];
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #1042
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #1062
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #917
    ...
    string stp_strs[3];
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #936
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #941
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #943
    stp_strs[0] = "";
    stringstream index_ss;
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #1028
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #1068
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #943
        ...
        if (pStruct->pDynamicStates) {
            for (uint32_t i = 0; i < pStruct->dynamicStateCount; i++) {
                index_ss.str("");
                index_ss << i;
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #978
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #1104
    if (pStruct->pDynamicStates)
...
#endif //VK_USE_PLATFORM_XLIB_KHR
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #1126
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #1135
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #1145
...
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #1152
std::string dynamic_display(const void* pStruct, const std::string prefix)
{
    using namespace std;
    ...
    switch (sType)
    {
        ...
        default:
        return string();
// CODEGEN : file C:/releasebuild/LoaderAndValidationLayers/vk_helper.py line #1182
    }
}